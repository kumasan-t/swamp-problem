...
import swamp.core.environment.map.AdaptableHeuristicFunction;
import swamp.core.environment.map.ExtendableMap;
import swamp.core.environment.map.MapAgent;
import swamp.core.environment.map.MapEnvironment;
import swamp.core.environment.map.Scenario;
import swamp.core.environment.map.SimplifiedRoadMapOfAustralia;
import swamp.core.environment.map.SimplifiedRoadMapOfPartOfRomania;
import swamp.core.environment.map.SimplifiedSwampMapOfShreksDen;
import swamp.core.util.datastructure.Point2D;
import swamp.gui.framework.AgentAppController;
import swamp.gui.framework.AgentAppEnvironmentView;
import swamp.gui.framework.AgentAppFrame;
import swamp.gui.framework.MessageLogger;
import swamp.gui.framework.SimpleAgentApp;
 ...
 * implementation is based on the {@link swamp.core.environment.map.MapAgent} and
 * the {@link swamp.core.environment.map.MapEnvironment}. It can be used as a
